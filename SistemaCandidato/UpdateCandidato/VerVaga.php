...
$query = "SELECT * FROM vagas where id = $Vaga";
...
<div id="signupbox" style=" margin-top:50px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
      <div class="panel-title">Informações da vaga selecionada</div>
            ...
            <form method="post" action="Update.php" enctype="multipart/form-data"> 
                ...
                <div id="div_id_username" class="form-group required">
                    ...
                    <div class="controls col-md-8 ">
                        <input class="input-md  textinput textInput form-control" id="id_username"readonly="readonly" maxlength="30" name="datainicio" value="<?= $linha['datainicio'] ?>" placeholder="Data incial" style="margin-bottom: 10px" type="date" />
                    </div>
                </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="controls col-md-8  offset-5">
                        <input type="submit" name="Aceitar" value="Aceitar" class="btn btn-primary btn btn-info" id="submit-id-signup" />
