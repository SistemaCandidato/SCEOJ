                     ...
                     <input type="hidden" name="id" value="<?= $id ?>">
                        ...
                        <div id="div_id_username" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md  textinput textInput form-control" id="id_username" maxlength="30" name="nome" placeholder="Nome da área" value="<?= $linha['nome']?>" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
                        <div id="div_id_password" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md emailinput form-control" id="id_Password" name="descricao" placeholder="Descrição"  value="<?= $linha['descricao']?> "style="margin-bottom: 10px" type="text" />
                            </div>     
                        </div>
